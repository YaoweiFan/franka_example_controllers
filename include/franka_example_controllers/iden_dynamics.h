...
Eigen::Matrix<double, 7, 7> MassMatrix(const Eigen::Matrix<double, 7, 1> &q);

Eigen::Matrix<double, 7, 7> CoriolisMatrix(const Eigen::Matrix<double, 7, 1> &q,const Eigen::Matrix<double, 7, 1> &dq);

Eigen::Matrix<double, 7, 1> GravityVector(const Eigen::Matrix<double, 7, 1> &q);

Eigen::Matrix<double, 7, 1> Friction(const Eigen::Matrix<double, 7, 1> &dq);
